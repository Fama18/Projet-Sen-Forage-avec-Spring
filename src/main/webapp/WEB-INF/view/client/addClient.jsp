...
<br />
	<br />
  <div class="container">
  <h1 style="text-align:center">Inserer un client</h1>
	<form action="Client/saveClient" method="post">
		 <div class="form-group">
		   <label for="nomFamille">Nom de Famille:</label>
		   <i class="fas fa-user"></i>
			<input type="text" name="nomFamille" class="form-control" placeholder="Entrer le nom de Famille" />
		 </div>
		 <div class="form-group">
		...
		<div class="form-group">
		  <label for="telephone">Telephone:</label>
		   <i class="fas fa-phone"></i>
			<input type="text" name="telephone" class="form-control" placeholder="Entrer le numero de telephone" />
		</div>
